...
export async function empIdSelector(input: string) {
...
export async function findEmployee(): Promise<string> {
...
export async function findManager(deptID: number): Promise<string> {
