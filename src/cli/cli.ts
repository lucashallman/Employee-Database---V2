...
export function returnCli(response: any): void {
    inquirer
        .prompt({
            type: 'confirm',
...
export async function nameCli(): Promise<any> {
...
export async function roleCli(deptID: number): Promise<string> {
...
export async function deptCli(): Promise<number> {
...
async function menuHandler(response: any) {
